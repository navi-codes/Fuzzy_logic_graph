...
Version:   5.0.0 (Arithmetic operations)
...
class FuzzyLogic():
    ...
    def plot_graph(self,graph_xa,graph_ya,graph_xb,graph_yb,graph_xc,graph_yc,label):
    ...
    def Addition(self,graph_xa,graph_ya,graph_xb,graph_yb):
        ...
        if(angle==1):
            self.plot_graph(graph_xa,graph_ya,graph_xb,graph_yb,graph_xc,graph_yc,"A+B")
        elif(angle==2):
            ...
            self.reverse(graph_xc,graph_yc,color="blue",label="A+B",crossColor='--b')

    def Subtraction(self,graph_xa,graph_ya,graph_xb,graph_yb):
        graph_xb=graph_xb[::-1]
        graph_xc=[(graph_xa[i]-graph_xb[i])for i in range(0,len(graph_xa))]
        graph_yc=self.get_graph_y()
        angle=int(input("Press 1 Graphicly Normal order fuzzy number\nPress 2 Graphicly self.Reverse order fuzzy number \n"))
        if(angle==1):
            self.plot_graph(graph_xa,graph_ya,graph_xb,graph_yb,graph_xc,graph_yc,"A-B")
        elif(angle==2):
            self.reverse(graph_xa,graph_ya,color="red",label="A",crossColor='--r')
    ...
    def minimum(self,graph_xa,graph_ya,graph_xb,graph_yb):
        ...
        angle=int(input("press 1 Graphicly Normal order fuzzy number\npress 2 Graphicly Reverse order fuzzy number\n"))
        if(angle==1):
            self.plot_graph(graph_xa,graph_ya,graph_xb,graph_yb,graph_xc,graph_yc,"min")
        elif(angle==2):
        ...
        angle=int(input("Press 1 Graphicly Normal order fuzzy number\nPress 2 Graphicly Reverse order fuzzy number\n"))
        if(angle==1):
            self.plot_graph(graph_xa,graph_ya,graph_xb,graph_yb,graph_xc,graph_yc,"max")
        elif(angle==2):
            self.reverse(graph_xa,graph_ya,color="red",label="A",crossColor='--r')
            self.reverse(graph_xb,graph_yb,color="green",label="B",crossColor='--g')
            self.reverse(graph_xc,graph_yc,color="blue",label="max A/B",crossColor='--b')
